...
This project builds a machine learning model to predict the probabilistic risk of a road accident for given data from the Kaggle road accident prediction dataset.
...
I chose the XGBoost regressor for the model, and to find the best possible version of this model, I:
...
* **Used Optuna for Bayesian optimization:** Instead of guessing hyperparameters, I used Optuna to automatically test dozens of combinations accelerated by the GPU.
